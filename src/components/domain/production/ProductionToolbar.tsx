        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="relative">
            ...
            >
              ...
              {activeFilterCount > 0 && (
                <span
                  className="ml-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-brand-accent px-1 text-[11px] font-semibold text-white"
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md border border-zinc-300 text-zinc-500 hover:bg-zinc-50"
          ...
          <span className="hidden text-xs text-zinc-400 sm:ml-auto sm:inline">
